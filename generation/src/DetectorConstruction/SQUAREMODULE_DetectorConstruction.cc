...
{ 
  ...
  G4Material* PbWO4 = new G4Material(name="PbWO4", density=8.28*g/cm3, nel=3);
  ...
  G4Element* elO = new G4Element(name="Oxygen", symbol="O2", z=8., a=16.00*g/mole);
...
G4VPhysicalVolume* DetectorConstruction::DefineVolumes()
{
  ...
  G4double preshowerThickness = 5.*cm;
  ...
  G4Material* absorberMaterial = G4Material::GetMaterial("PbWO4");
  G4Material* gapMaterial = G4Material::GetMaterial("PbWO4");
  G4Material* preshowerMaterial = G4Material::GetMaterial("G4_Pb");
  ...
  //
  G4VSolid* preshowerS 
    = new G4Box("Preshower",             // its name
                 calorSizeXY/2, calorSizeXY/2, preshowerThickness/2); // its size
                         
  G4LogicalVolume* preshowerLV
    = new G4LogicalVolume(
                 preshowerS,             // its solid
                 preshowerMaterial,      // its material
                 "Preshower");           // its name
                                   
  new G4PVPlacement(
                 0,                // no rotation
                 G4ThreeVector(0., 0., -(calorThickness+preshowerThickness)/2), // its position
                 preshowerLV,       // its logical volume                         
                 "Preshower",       // its name
                 worldLV,          // its mother  volume
                 false,            // no boolean operation
                 0,                // copy number
